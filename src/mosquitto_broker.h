...
struct mqtt3_config {
	...
	bool use_epoll;
	bool use_subhier_accelerator;
	bool with_bridge;
	char *topic_change_keepalive;	
	char *topic_notice_online;
...
struct _mosquitto_subhier {
	...
	struct _mosquitto_subhier *prev;
...
struct mosquitto_db{
	...
	struct mosquitto *contexts_with_msg_by_sock;
...
/* ============================================================
 * Function about subscribe tree ------by jason.hou
 * ============================================================ */
...
int mqtt3_retain_queue_fast(struct mosquitto_db *db, struct mosquitto *context, const char *sub, int sub_qos);
void clear_sub_hash();
